...
public class Escenario {
	...
	public Escenario(Stage primaryStage) {
		...
		// Clase Chat_usuarios
		Chat_usuarios chat_usua = new Chat_usuarios();
...
//PARTE DERECHA	
		...
		chat_usua.labelTopRight6, chat_usua.labelTopRight5,
		chat_usua.labelTopRight4, chat_usua.labelTopRight3, 
		chat_usua.labelTopRight2,chat_usua.labelTopRight1);
...
//PARTE IZQUIERDA	
		...
		chat_usua.stackPaneuser3, chat_usua.stackPaneuser4, 
		chat_usua.stackPaneuser5, chat_usua.stackPaneuser6);
		...
		flowPaneTopLeft.getChildren().addAll(imaRp.fimaadmin1, chat_usua.lbladmin1);			
